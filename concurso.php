...
$(document).ready(function () {	
	...
	dataSource = new kendo.data.DataSource({
		transport: {
			read:  {
				...
				dataType: "json",
				data:{id:"maxconcurso2",fechai:$("#fechai").val(),fechaf:$("#fechaf").val(),max:0}
			},
	...
	var grid =$("#grid").kendoGrid({
		...
		filterable:true,
		columns: [
            {field: "idregistros_concurso", template:"#if (data.estado=='Contactado'){# <span class='contactado'>Contactado</span> #} else {#<button type='button' onclick='contactado(#= idregistros_concurso#,this)'>Contactar</button> #}#",width:"100px",title:"&nbsp",filterable:false},
			{ field: "idregistros_concurso", title:"Id", width:'70px'},
			{ field: "apellidos", title:"Apellidos", width:'150px'},
            { field: "nombres", title:"Nombres", width:'150px'},
            { field: "mail", title:"Mail", width:"200px"},
            { field: "telefono", title:"Tel. 1",width:"100px"},
            { field: "telefono2", title:"Tel. 2", width:'100px'},
            { field: "ciudad", title:"Ciudad", width:'100px'},
            { field: "pueblo", title:"Pueblo", width:'100px'},
            { field: "codigo", title:"Codigo",width:"250px"},
            { field: "fecha_creacion", title:"Fecha", width:'100px'},
            { field: "dir", title:"Dirección",width:"250px"},
